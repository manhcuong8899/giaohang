<div class="row">
    ...
    <div class="col-md-12">
        <div class="checkout-form-list">
            ...
            <input placeholder="Nhập Họ và Tên" type="text" name="full_name" value="{{Auth::user()->full_name}}">
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="checkout-form-list">
            ...
            <input placeholder="Địa chỉ" type="text" name="address" id="address" value="{{\Illuminate\Support\Facades\Auth::user()->profile->address}}">
        </div>
    </div>
    <div class="col-md-12">
        <div class="checkout-form-list">
            <label>Điện thoại<span class="required redform">*</span></label>
            <input placeholder="Điện thoại" type="text" name="phone" id="phone" value="{{\Illuminate\Support\Facades\Auth::user()->profile->phone}}">
        </div>
    </div>
    @else
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="checkout-form-list">
                <label>Điện thoại<span class="required redform">*</span></label>
                <input placeholder="Điện thoại" type="text" name="phone" id="phone">
            </div>
        </div>
        @endif
    ...
    <div class="col-md-12">
        <div class="checkout-form-list">
            ...
            <input placeholder=" Địa chỉ email" type="email" name="email" id="email" value="{{Auth::user()->email}}">
        </div>
    </div>
</div>